    ...
    <div class="relative w-full max-w-2xl max-h-full p-4">
        ...
        <div class="relative bg-[#3b206b] rounded-lg shadow">
            ...
            <div class="flex items-center p-4 border-t border-gray-200 rounded-b md:p-5 dark:border-gray-600">
                <button type="button" data-modal-hide="profile-modal" data-modal-target="edit-profile-modal" data-modal-toggle="edit-profile-modal" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Ubah Data Email</button>
            </div>
        </div>
    </div>
</div>