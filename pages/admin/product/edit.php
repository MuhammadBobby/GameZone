    ...
    <div class="relative w-full max-w-md max-h-full p-4">
        <div class="relative bg-[#3b206b] rounded-lg shadow">
            <div class="flex items-center justify-between p-4 border-b rounded-t md:p-5 dark:border-gray-600">
                ...
                <button type="button" class="inline-flex items-center justify-center w-8 h-8 text-sm text-gray-400 bg-transparent rounded-lg ms-auto hover:bg-gray-600 hover:text-white" data-modal-toggle="edit-product-modal">
                    <!-- Close button SVG -->
                </button>
            </div>
            <form action="services/submit_product.php" method="POST" enctype="multipart/form-data" class="p-4 md:p-5">
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="file" accept="image/*" name="image" id="image" class=" text-sm rounded-lg focus:ring-purple-600 focus:border-purple-600 block w-full p-2.5 bg-white border-gray-500">
                    </div>
                </div>
                <button type="submit" class="text-white inline-flex items-center gap-0 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-yellow-500 hover:bg-yellow-600 focus:ring-yellow-700">
                    Simpan
                </button>
            </form>
        </div>
